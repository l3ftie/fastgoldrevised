  ...
  return (
    <>
      ...
      <div className="relative h-80">
        ...
        <Image fill className="object-cover" src="/pngegg.png" alt={post.title} />
        <div className="max-w-7xl mx-auto relative z-20 flex flex-col items-center justify-end md:pb-10  gap-3 md:px-0 h-full">
